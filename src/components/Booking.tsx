        ...
        {submitStatus !== 'success' ? (
          ...
          >
            ...
            <p className="text-[#5E6470] text-sm leading-relaxed max-w-sm opacity-90 mb-8 font-normal">
              Thank you, <span className="font-semibold text-[rgba(30,50,90,0.9)]">{name}</span>. We have received your contact details. A software engineer from our team will reach out shortly to coordinate the session.
            </p>
